...
shapiro_test <- shapiro.test(train_data$LULC_water) 
...
result <- cor.test(train_data$LULC_water, train_data$status, method = "kendall")  

print(result)


#no correlation found, p=0.963, z=-0.04698