...
shapiro_test <- shapiro.test(train_data$wc_bio6) 
...
result <- cor.test(train_data$wc_bio6, train_data$status, method = "kendall")  


print(result)


#strong correlation found, p<0.001, z=15.84