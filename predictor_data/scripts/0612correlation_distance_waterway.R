...
shapiro_test <- shapiro.test(punktdaten$distance_waterway) 
...
result <- cor.test(train_data$distance_waterway, train_data$status, method = "kendall")  
...
#negative correlation found, p<0.001, z=-14.349