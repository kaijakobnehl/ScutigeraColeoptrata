...
shapiro_test <- shapiro.test(punktdaten$LULC_crops) 
...
result <- cor.test(train_data$LULC_crops, train_data$status, method = "kendall")  


print(result)


#strong negative correlation found, p<0.001, z=-19.424