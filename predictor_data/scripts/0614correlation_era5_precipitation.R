...
shapiro_test <- shapiro.test(train_data$era5_precipitation) 
...
result <- cor.test(train_data$era5_precipitation, train_data$status, method = "kendall")  
...
#weak positive correlation found, p<0.001, z=5.099