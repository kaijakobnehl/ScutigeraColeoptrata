...
shapiro_test <- shapiro.test(train_data$LULC_trees) 
...
result <- cor.test(train_data$LULC_trees, train_data$status, method = "kendall") 

print(result)



#strong negative correlation found, p<0.001, z=-15.272