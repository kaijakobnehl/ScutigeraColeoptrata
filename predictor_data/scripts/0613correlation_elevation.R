...
shapiro_test <- shapiro.test(train_data$elevation) 
...
result <- cor.test(train_data$elevation, train_data$status, method = "kendall")  

print(result)



#weak negative correlation found, p<0.05, z=-2.197