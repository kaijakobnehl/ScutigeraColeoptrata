...
shapiro_test <- shapiro.test(punktdaten$distance_railway) 
...
result <- cor.test(train_data$distance_railway, train_data$status, method = "kendall")  

print(result)


#strong negative correlation found, p<0.001, z=-18.654