...
shapiro_test <- shapiro.test(train_data$wc_bio1) 
...
result <- cor.test(train_data$wc_bio1, train_data$status, method = "kendall") 
...
#strong correlation found, p<0.001, z=19.753