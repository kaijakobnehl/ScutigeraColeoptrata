...
shapiro_test <- shapiro.test(train_data$era5_temperature) 
...
result <- cor.test(train_data$era5_temperature, train_data$status, method = "kendall")  
...
#strong correlation found, p<0.001, z=15.794