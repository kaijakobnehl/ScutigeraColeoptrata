...
shapiro_test <- shapiro.test(train_data$clc_port_areas) 
...
result <- cor.test(train_data$clc_port_areas, train_data$status, method = "kendall")  

print(result)


#no correlation found, p=0.319, z=0.998