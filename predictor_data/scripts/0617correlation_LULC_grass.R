...
shapiro_test <- shapiro.test(train_data$LULC_grass) 
...
result <- cor.test(train_data$LULC_grass, train_data$status, method = "kendall")  
...
#strong negative correlation found, p<0.001, z=-16.288