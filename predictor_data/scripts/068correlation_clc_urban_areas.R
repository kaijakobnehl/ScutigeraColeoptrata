...
shapiro_test <- shapiro.test(punktdaten$clc_urban_areas) 
...
result <- cor.test(train_data$clc_urban_areas, train_data$status, method = "kendall") 
...
#strong significant positive correlation found, p<0.001, z=20.677